./bin/bzrflag --world=maps/twoteams.bzw --default-tanks=4 --friendly-fire --occgrid-width=100 --default-true-positive=.97 --default-true-negative=.9 --red-port=50100 --green-port=50101 --purple-port=50102 --blue-port=50103 $@ &
