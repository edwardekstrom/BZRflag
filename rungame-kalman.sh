./bin/bzrflag --world=maps/simple_no_obstacles.bzw --default-tanks=1 --default-posnoise=5 --red-port=50100 --green-port=50101 --purple-port=50102 --blue-port=50103 $@ &
sleep 2
...
# python bzagents/straight_line_pigeon.py localhost 50102 &
